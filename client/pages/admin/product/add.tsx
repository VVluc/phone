                ...
                <Grid xs={4} css={{ display: 'block!important' }}>
                  <Row>
                    <Card variant="bordered" css={{ p: 15, w: 390, h: 390 }}>
                      <ImagePreview getValues={getValues} watch={watch} control={control} name="image1" />
                    </Card>
                  </Row>
                  <Row wrap="wrap" justify="center" css={{ mt: 15 }}>
                    {[...Array(6)].map((i, index) => (
                      ...
                      >
                        <ImagePreview getValues={getValues} watch={watch} control={control} name={`image${index + 2}`} small />
                      </Card>
                    ))}
                  </Row>
                </Grid>
