  ...
  >
    <SwiperSlide>
      <div style={{ width: '100%', height: '41.5vw' }}>
        <NextImg src={carousel1} layout="fill" priority objectFit="cover" alt="Default Image" />
      </div>
    </SwiperSlide>
    <SwiperSlide>
      <div style={{ width: '100%', height: '41.5vw' }}>
        <NextImg src={carousel2} layout="fill" priority objectFit="cover" alt="Default Image" />
      </div>
    </SwiperSlide>
    <SwiperSlide>
      <div style={{ width: '100%', height: '41.5vw' }}>
        <NextImg src={carousel3} layout="fill" priority objectFit="cover" alt="Default Image" />
      </div>
    </SwiperSlide>
    <SwiperSlide>
      <div style={{ width: '100%', height: '41.5vw' }}>
        <NextImg src={carousel4} layout="fill" priority objectFit="cover" alt="Default Image" />
      </div>
    </SwiperSlide>
    <SwiperSlide>
      <div style={{ width: '100%', height: '41.5vw' }}>
        <NextImg src={carousel5} layout="fill" priority objectFit="cover" alt="Default Image" />
      </div>
    </SwiperSlide>
    <SwiperSlide>
      <div style={{ width: '100%', height: '41.5vw' }}>
        <NextImg src={carousel6} layout="fill" priority objectFit="cover" alt="Default Image" />
      </div>
    </SwiperSlide>
  </Swiper>
);
                  ...
                  <a style={{ width: '100%' }}>
                    <Card variant="bordered" isHoverable>
                      ...
                      <Card.Body css={{ py: isMobile ? '$6' : '$10' }}>
                        <Image width={isXs ? 235 : 100} height={isXs ? 235 : 100} src={i.images[0].url} />
                        <Spacer y={1} />
                        <Text
                          h3
                          css={{
...
const Skeleton = () => {
  ...
  return (
    <Card variant="bordered" isHoverable css={{ backgroundColor: '$accents0' }}>
      ...
      <Card.Body css={{ py: isMobile ? '$6' : '$10' }}>
        <div style={{ width: isXs ? 235 : 100, height: isXs ? 235 : 100 }}></div>
        <Spacer y={1} />
        <Text
          h3
          css={{
...
const Articles = () => {
  const { data: articles, error, mutate, isValidating } = useSWR<ArticleType[]>('/articles/home', getAllArticlesForHome);
  const isXs = useMediaQuery('(min-width: 650px)');
              ...
              <Grid key={i.slug} xs={12} sm={4}>
                <Link href={`article/${i.slug}`}>
                  <a style={{ width: '100%' }}>
                    <Card variant="bordered" isHoverable>
                      <Card.Body css={{ p: 0 }}>
                        <Card.Image src={i.bannerImage.url} objectFit="cover" width="100%" height={218} alt="" />
                      </Card.Body>
                      <Card.Footer
                        css={{
            ...
            <Grid xs={12} sm={6}>
              <Card variant="bordered" isHoverable>
                <Card.Body css={{ p: isXs ? 50 : 30 }}>
                  <Row align="center" css={{ flexDirection: isXs ? 'row' : 'column' }}>
                    <div className="">
                      <Text h2 css={{ fontWeight: 500, fontSize: isXs ? 36 : 24 }}>
                        Chọn điện thoại
                      </Text>
                      <Text
                        h3
                    ...
                    <Image width="140px" height="140px" objectFit="cover" src="/iphone-14-pro-tim.jpg" alt="" />
                  </Row>
                </Card.Body>
              </Card>
            </Grid>
              ...
              <Card variant="bordered" isHoverable>
                <Card.Body css={{ p: isXs ? 50 : 30 }}>
                  <Row align="center" css={{ flexDirection: isXs ? 'row' : 'column' }}>
                    ...
                    <Image width="140px" height="140px" objectFit="cover" src="/phu-kien.png" alt="" />
                  </Row>
                </Card.Body>
              </Card>
            </Grid>
