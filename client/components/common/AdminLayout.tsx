    ...
    <Card variant="bordered" css={{ $$cardColor: '$colors$white' }}>
      <Card.Body>
        <Button
          ...
          icon={<AiOutlineHome />}
          css={{
            backgroundColor: router.pathname.includes('/admin/dashboard') ? '$secondary' : '',
          }}
        ...
        <Spacer y={1} />
        {session && session.roles.some((e: string) => e === 'admin' || e === 'manager') && (
          <>
            <Button
              ...
              css={{
                backgroundColor: router.pathname.includes('/admin/category') ? '$secondary' : '',
              }}
              ripple={false}
            >
              Danh mục
        ...
        {session && session.roles.some((e: string) => e === 'admin' || e === 'manager') && (
          <>
            <Button
              ...
              css={{
                backgroundColor: router.pathname.includes('/admin/attribute') ? '$secondary' : '',
              }}
              ripple={false}
            >
              Thuộc tính
        ...
        {session && session.roles.some((e: string) => e === 'admin' || e === 'manager') && (
          <>
            <Button
              ...
              css={{
                backgroundColor: router.pathname.includes('/admin/product') ? '$secondary' : '',
              }}
        ...
        <Button
          ...
          css={{
            backgroundColor: router.pathname.includes('/admin/order') ? '$secondary' : '',
          }}
        ...
        {session && session.roles.some((e: string) => e === 'admin') && (
          <>
            <Button
              ...
              css={{
                backgroundColor: router.pathname.includes('/admin/employee') ? '$secondary' : '',
              }}
        ...
        {/* <Button
          ...
          css={{
            backgroundColor: router.pathname.includes('/admin/setting') ? '$secondary' : '',
          }}
    ...
    <>
      <div style={{ backgroundColor: '#fdfdff' }}>
        ...
        <Navbar isBordered>
          ...
          <Navbar.Content>
            <Navbar.Item>
              <Button onPress={handleSignOut} auto flat color="error">
                Đăng xuất
              </Button>
            </Navbar.Item>
          </Navbar.Content>
